...
Latest minimal V12-style Session Snapshot command commit: this patch
```

## Completion Line

Entry Window Radar now has a minimal V12-style save_session_snapshot command that writes a restartable session checkpoint to outputs/session_snapshot.md without claiming completion, generating Quest Snapshot automatically, calling AI, or authorizing runtime expansion.
