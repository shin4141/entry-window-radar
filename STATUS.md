...
Latest Session Snapshot misuse guard commit: this patch
```

## Completion Line

Entry Window Radar now prevents first-time users and future AI agents from mistaking outputs/session_snapshot.md for a full handoff: it is a V12-style restart checkpoint, while project-level handoff still requires a Quest Snapshot or Handoff Header.
